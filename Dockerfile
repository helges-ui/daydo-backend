...
# Run the application (bind to PORT env var, log to stdout/stderr)
CMD ["sh", "-c", "gunicorn --bind 0.0.0.0:${PORT:-8000} --workers 3 --timeout 120 --access-logfile - --error-logfile - daydo_backend.wsgi:application"]
